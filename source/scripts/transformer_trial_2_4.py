...
dummy_dataset_0 = LCs(lc_length, data_dir+'dummy_data_0.h5')
dummy_dataset_0.load_data_into_memory()
dummy_dataset_0.packed=True

dummy_dataset_1 = LCs(lc_length, data_dir+'dummy_data_1.h5')
dummy_dataset_1.load_data_into_memory()
dummy_dataset_1.packed=True

dummy_dataset_2 = LCs(lc_length, data_dir+'dummy_data_2.h5')
dummy_dataset_2.load_data_into_memory()
dummy_dataset_2.packed=True

dummy_dataset_3 = LCs(lc_length, data_dir+'dummy_data_3.h5')
dummy_dataset_3.load_data_into_memory()
dummy_dataset_3.packed=True

dummy = [dummy_dataset_0,dummy_dataset_1,dummy_dataset_2,dummy_dataset_3]
# epochs = [20]
# epochs = [50, 100]
# lrates = [1e-03]
                        ...
                        for f in freeze_latent:
                            for fine_tune in fine_tune_bool:
                                ...
                                if not os.path.isfile(name+'/seed_1772670/saved_models/'+model_save_name_final_train):
                                    ...
                                    print(model_save_name_final_train)
                                ...
                                #do more of that reconstruction, but like super briefly

                                for c in range(2):
                                    dummy_d=dummy[c]
                                    experiment.reset_experiment_datasets(train_data=dummy_d, test_data=test_dataset)
                                    nn.reset_loss(e, k0=1-k1_low, k1=k1_low)
                                    exp_params_reconstruction['network_model']=nn
                                    exp_params_reconstruction['pick_up'] = True
                                    exp_params_reconstruction['num_epochs'] = 5
                                    experiment.reset_experiment_params(exp_params_reconstruction)
                                    
                                    model_save_name_final_train = 'final_model_e{}_k1l{}_{}_dummy.pth.tar'.format(e,k1_low,f)
                                    model_save_name_train = 'best_validation_model_e{}_k1l{}_{}_dummy.pth.tar'.format(e,k1_low,f)

                                    experiment.run_experiment(
                                        train_data_name='real_e{}_k1l_{}_{}_dummy_{}'.format(e,k1_low,f,c),
                                        test_data_name='test_e{}_k1l_{}_{}_dummy_{}'.format(e,k1_low,f,c),
                                        model_load_name_train=model_load_name_train,
                                        model_save_name_train='best_validation_model_e{}_k1l{}_{}_dummy.pth.tar'.format(e,k1_low,f),
                                        model_load_name_final_train=model_load_name_final_train,
                                        model_save_name_final_train='final_model_e{}_k1l{}_{}_dummy.pth.tar'.format(e,k1_low,f)
                                    ...
                                    experiment.reset_experiment_datasets(test_data=real_test_dataset)
                                    experiment.run_test_phase(
                                        'test_real_e{}_k1l_{}_{}_dummy_{}'.format(e,k1_low,f,c),
                                        model_name=model_save_name_final_train)
                                ...
                                # model_load_name_train=model_save_name_train
                                # model_load_name_final_train=model_save_name_final_train
                                test_data_name = 'test_e{}_k1l_{}_{}_dummy'.format(e,k1_low,f)
                                test_real_data_name = 'test_real_e{}_k1l_{}_{}_dummy'.format(e,k1_low,f)
                                train_data_name='real_e{}_k1l_{}_{}_dummy'.format(e,k1_low,f)
                                nn.classify=True
                                ...
                                exp_params_classification['network_model']=nn
                                experiment.reset_experiment_params(exp_params_classification)
                                experiment.reset_experiment_datasets(test_data=test_dataset)
