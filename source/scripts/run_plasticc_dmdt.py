...
for lc_length in lc_lengths:
    for b_code in binning_codes:
        exp_name = results_dir+"{}_{}x{}_b{}augmented_noise2".format(arch_code,lc_length,lc_length,b_code)
        training_data_file=data_dir+'dmdts_training_{}x{}_b{}augmented_noise2.h5'.format(lc_length,lc_length,b_code)
